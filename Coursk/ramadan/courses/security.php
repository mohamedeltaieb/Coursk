    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchInput.addEventListener('input', function () {
            ...
            cards.forEach(card => {
                ...
                const instructor = card.querySelector('.description').textContent.toLowerCase();
...
<h1 style="font-size: 35px;margin-bottom: 20px;">Cyber-security</h1>
    <div class="container"> 
       
    <div class="download-container">
            <a href="../Roadmao/cyber-security.pdf" >
                <button class="Roadmap">Roadmap</button>
            </a>
        </div>

        <?php include 'serversecurity.php'; ?>
    </div>
</body>
</html>

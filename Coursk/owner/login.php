...
<body>
   <div class="login">
      <img src="bglogin.jpg" alt="login image" class="login__img">
      ...
      <form action="" method="post" class="login__form">
         ...
         <button type="submit" class="login__button" name="login_owner">Login</button>

         <p class="login__register">
            Don't have an account? <a href="rigisterowner.php">Register</a>
         </p>
      </form>
   </div>
</body>

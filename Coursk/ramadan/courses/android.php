...
<h1 style="font-size: 35px;margin-bottom: 20px;">Android Studio</h1>
    <div class="container">
      
    <div class="download-container">
    <a href="../Roadmao/android.pdf"><button  class="Roadmap" >Roadmap</button></a>
            </a>
        </div>
        <?php include 'serverandroid.php'; ?>
    </div>
</body>
</html>
